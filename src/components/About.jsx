  ...
  return (
    <Section id="about-me" title="About Me">
      <div className="flex flex-col items-center gap-8 spc:flex-row spc:gap-12">
        ...
        >
          <div className="group rounded-3xl bg-gradient-to-br from-stone-700/60 via-stone-600/50 to-stone-800/60 p-5 ring-1 ring-white/10 backdrop-blur-sm transition duration-300 hover:ring-cyan-300/40 sm:p-7">
