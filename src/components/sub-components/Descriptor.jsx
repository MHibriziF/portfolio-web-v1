    ...
    return (
      <div className="flex spc:flex-row-reverse flex-col justify-start items-center mb-4">
        ...
        <div className="flex flex-col items-start font-poppins spc:text-base text-sm">
          ...
          <div className="relative ml-4 spc:w-[40rem] w-72 h-36 group">
            <div className="absolute spc:mr-4 right-0 w-4 mt-4 h-32 rounded-full bg-slate-700 group-hover:rounded-3xl spc:group-hover:w-[37rem] group-hover:w-72 transition-all duration-500"></div>
