    ...
    <div className="flex w-full h-auto mt-32 justify-center text-teal-50">
      ...
      >
        <div data-aos="fade-down" data-aos-duration="2000">
          <h1 className="md:text-6xl text-3xl pb-4 hover:scale-125 hover:text-white">
            Hello!
          </h1>
        </div>
        <div data-aos="zoom-in" data-aos-duration="2000">
          <p className="md:text-2xl text-base hover:scale-105 pb-4 hover:text-white">
            My name is
          </p>
        </div>
        <div data-aos="fade-up" data-aos-duration="2000">
          <h2 className="md:text-3xl text-lg hover:scale-125 hover:-rotate-3 hover:text-white">
